...
/*module.exports.findByPaging = (pagenum, pagesize, callback) => {
  ...
  ON p.category_id = c.id LIMIT ?,?; SELECT COUNT(*) AS total FROM posts; SELECT id AS cate_id,NAME AS cate_name FROM categories;`, [pagenum, pagesize], function (error, results) {
